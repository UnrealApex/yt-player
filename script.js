...
// TODO: delete queue items
// FIXME: fix thumbnails not appearing
...
function minimizeOverlay() {
  ...
  document.querySelector("#overlay").disabled = true;
  if (isLoaded) {
...
document.querySelector("form").addEventListener("click", function () {
  if (document.querySelector("#queue-radio").checked) {
    ...
    document.querySelector("#open-queue").click();
...
document.querySelector("#open-queue").addEventListener("click", function () {
  // alert("clicked");
  if (document.querySelector(".dropdown-content").style.display == "block") {
    ...
    document.querySelector("#open-queue").style.backgroundColor = "lightgray";
    document.querySelector(".dropdown-content").style.display = "block";
    document.querySelector("#queue-input").focus();
  }
});

// document.querySelector("#open-queue").onclick = function () {
//   //   if (document.querySelector(".dropdown-content").style.display == "none") {
//   //   document.querySelector(".dropdown-content").style.display = "block";
//   // } else if (document.querySelector(".dropdown-content").style.display == "block") {
//   //   document.querySelector(".dropdown-content").style.display = "none";
//   // } else {
//   // }
